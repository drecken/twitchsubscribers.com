            ...
            <form action="#">
                <table id="subLevelCheckboxes">
                    <tr>
                        <td>
                            <label for="prime">
                                <input id="prime" data-level="p" type="checkbox" class="filled-in tier-checkbox"
                                       checked="checked" name="prime"/>
                                <span></span>
                        ...
                        <td>
                            <label for="tier1">
                                <input id="tier1" data-level="1" type="checkbox" class="filled-in tier-checkbox"
                                       checked="checked" name="tier1"/>
                                <span></span>
                        ...
                        <td>
                            <label for="tier2">
                                <input id="tier2" data-level="2" type="checkbox" class="filled-in tier-checkbox"
                                       checked="checked" name="tier2"/>
                                <span></span>
                        ...
                        <td>
                            <label for="tier3">
                                <input id="tier3" data-level="3" type="checkbox" class="filled-in tier-checkbox"
                                       checked="checked" name="tier3"/>
                                <span></span>
                    ...
                    <td>
                        <div class="user-info">
                            <div>
                                ...
                                @else
                                    <img src="https://static-cdn.jtvnw.net/jtv_user_pictures/xarth/404_user_70x70.png"
                                         height="50px">
                                @endif
                            </div>
                            <div>
